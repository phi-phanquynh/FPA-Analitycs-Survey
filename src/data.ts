...
const analyticsItems: AnalyticsItemDraft[] = [
  {
    ...
    analysisDescription: "主要KPIを1画面に集め、異常値と担当領域を確認する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "予算・前年との差を科目や部門で分解し、差異理由を追う分析です。",
  ...
  },
  {
    ...
    analysisDescription: "財務・顧客・業務・人材の指標を並べ、経営状態を俯瞰する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "売上変動を単価・数量・顧客・商品などに分けて主因を見る分析です。",
  ...
  },
  {
    ...
    analysisDescription: "商品や顧客ごとの成長率と収益性を比べ、伸ばす対象を見極める分析です。",
  ...
  },
  {
    ...
    analysisDescription: "商談残高と受注確度から、将来の売上着地を見込む分析です。",
  ...
  },
  {
    ...
    analysisDescription: "利益率の変化を価格・原価・構成比に分け、改善余地を探す分析です。",
  ...
  },
  {
    ...
    analysisDescription: "商品・顧客・事業ごとの売上と利益貢献を比較する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "利益の増減を売上・粗利率・費用などの要因に分解する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "費用の大きさを科目や部門で可視化し、増加箇所を見つける分析です。",
  ...
  },
  {
    ...
    analysisDescription: "固定費・変動費と費用ドライバーを分け、損益分岐点を確認する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "部門や基準値との比較から、削減余地が大きい費用を探す分析です。",
  ...
  },
  {
    ...
    analysisDescription: "入出金予定から将来の資金残高を見通し、資金不足の時期を確認する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "売掛金・在庫・買掛金の動きを見て、資金が滞る場所を特定する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "悪化ケースを置いて、資金残高と借入枠がどこまで耐えられるかを見る分析です。",
  ...
  },
  {
    ...
    analysisDescription: "最新実績を反映しながら、売上・利益の着地見通しを更新する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "複数の予算前提を置き、売上・利益・投資額の違いを比べる分析です。",
  ...
  },
  {
    ...
    analysisDescription: "予測と実績のズレや予算消化の偏りを見つけ、見通しの精度を点検する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "単価・数量・受注率を動かし、売上や利益への影響度を見る分析です。",
  ...
  },
  {
    ...
    analysisDescription: "為替・原材料・人件費の前提変化が利益へ与える影響を試算する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "複数ケースで売上・利益・資金を並べ、下振れ時の影響を見る分析です。",
  ...
  },
  {
    ...
    analysisDescription: "投資案件を回収期間・効果・リスクで並べ、優先順位を付ける分析です。",
  ...
  },
  {
    ...
    analysisDescription: "人員や施策費に対する売上・利益・商談効果を比較する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "事業ごとの成長性・収益性・リスクを並べ、資本配分を考える分析です。",
  ...
  },
  {
    ...
    analysisDescription: "売上・粗利・受注などの変化から、収益悪化の兆候を早めに拾う分析です。",
  ...
  },
  {
    ...
    analysisDescription: "費用の急増や支出ペースを見て、予算超過の兆候を検知する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "顧客依存や財務KPIを並べ、リスクが集中する領域を見つける分析です。",
  ...
  },
  {
    ...
    analysisDescription: "数値差異と要因データから、月次報告用のコメント案を作る分析です。",
  ...
  },
  {
    ...
    analysisDescription: "KPIや差異、リスクを整理し、会議で見る要点を要約する分析です。",
  ...
  },
  {
    ...
    analysisDescription: "施策・数値・現場コメントをつなぎ、重要課題の関係を整理する分析です。",
